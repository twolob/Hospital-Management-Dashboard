          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {[
                  { name: 'Paracetamol 500mg', category: 'Medication', stock: 2500, expiry: '2024-12-31', status: 'In Stock' },
                  { name: 'Surgical Masks', category: 'PPE', stock: 100, expiry: '2024-06-30', status: 'Low Stock' },
                  { name: 'Blood Pressure Monitor', category: 'Equipment', stock: 15, expiry: null, status: 'In Stock' },
                ].map((item, index) => (
